  ...
  render() {
    return (
      <tr onClick={() => this.setState({showDescription: !this.state.showDescription})}>
        ...
        {this.state.showDescription ? <td className="fish-description">Does anyone know where my dad is?</td> :<td className="fish-description"> {this.props.fish.description}</td>}
      </tr>
    )
  }
}
